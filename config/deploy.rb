...
namespace :socky do
  ...
  task :restart, :role => :app do
    ...
    run "cd #{deploy_to}/current/config; rm socky.yml; rm socky_hosts.yml"
    
 #    ln -nfs socky_production.yml socky.yml && ln -nfs socky_hosts_production.yml socky_hosts.yml"
